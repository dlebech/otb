...
export default function FileInput({ handleFileChange, handleFile }: FileInputProps) {
  ...
  return (
    <div className="flex flex-wrap gap-4">
      <div
        className={`w-full max-w-lg rounded-lg border-2 border-dashed p-8 text-center transition-colors cursor-pointer ${
          isDragging
      ...
      <p className="w-full max-w-lg text-xs text-gray-400 mt-1">
