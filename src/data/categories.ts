...
export const foodAndDrink: Category = { id: uuidv4(), name: 'Food & Drink' };
export const home: Category = { id: uuidv4(), name: 'Home' };
export const transportation: Category = { id: uuidv4(), name: 'Transportation' };
export const shopping: Category = { id: uuidv4(), name: 'Shopping' }
export const entertainment: Category = { id: uuidv4(), name: 'Entertainment' };
export const travel: Category = { id: uuidv4(), name: 'Travel' };
export const money: Category = { id: uuidv4(), name: 'Money' }
